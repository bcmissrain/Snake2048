...
namespace CookLibrary.SingleGame
{
    class WinDialog
    {
        ...
        public WinDialog()
        {
            background = new SASimpleSprite("Images/singleWin");
            this.choice = Choice.Leave;
            buttons = new SASimpleSprite[2];
            buttons[0] = new SASimpleSprite("Images/singleWin", new Rectangle(80, 480, 125, 55), new Vector2(80, 480), Color.White);
            buttons[1] = new SASimpleSprite("Images/singleWin", new Rectangle(275, 480, 125, 55), new Vector2(275, 480), Color.White);
            ResetUpFinished();
        }
        public void MoveUp()
        {
