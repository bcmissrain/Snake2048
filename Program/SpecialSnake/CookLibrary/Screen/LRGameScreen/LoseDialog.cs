...
namespace CookLibrary.LRGame
{
    class LoseDialog
    {
        ...
        public LoseDialog()
        {
            background = new SASimpleSprite("Images/lrAskContinue");
            this.choice = Choice.Continue;
            buttons = new SASimpleSprite[2];
            buttons[0] = new SASimpleSprite("Images/lrAskContinue", new Rectangle(40,470,190,70), new Vector2(40, 470), Color.White);
            buttons[1] = new SASimpleSprite("Images/lrAskContinue", new Rectangle(250,470,190,70), new Vector2(250, 470), Color.White);
            ResetUpFinished();
        }
        public void MoveUp()
        {
