...
namespace Samurai
{
    ...
    public static class OldSAGraphicManager
    {
        private static Dictionary<string, Texture2D> textureDictionary;

        static OldSAGraphicManager()
        {
        ...
        public static Texture2D GetImage(string name)
        {
            ...
            {
                textureDictionary.Add(name, SAGlobal.Content.Load<Texture2D>(name));
            }
